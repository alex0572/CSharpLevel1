...
namespace DZ_Lesson1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region ДЗ 1-4b* Обмен значений в двух переменных (без использования третьей переменной)   
            /*Написать программу обмена значениями двух переменных: без использования третьей переменной. Ляшенко А.В.*/
            ...
            a = a + b; // в 'a' записываем сумму 'a' и 'b'
            b = a - b; // здесь уже 'b' равно начальному 'a'
            a = a - b; // 'а' теперь равно начальному 'b'
